...
const RPA = () => {
  ...
  return (
    <Layout>
      ...
      >
        ...
        <div>
          ...
          >
            What is <span className="text-gradient-blue">RPA?</span>
          </h2>
          <p 
    ...
    >
      ...
      >
        <h2 className="text-3xl md:text-4xl font-display font-bold">Our <span className="text-gradient-blue">Process</span></h2>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {["Analysis", "Design", "Development", "Deployment"].map((step, i) => (
          ...
          >
            <div className="text-4xl font-display font-bold text-gradient-blue mb-2">0{i + 1}</div>
